...
const Costumersadminpage: React.FC = () => {
        ...
        <div className="max-w-[1300px] h-[750px] bg-white rounded-lg mt-14">
          <div className="relative overflow-x-auto">
            <div className="flex gap-[750px] mt-7 ml-5 mb-5 items-center">
              <span className="font-bold">Costumers</span>
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <thead className="text-xs text-gray-700 uppercase bg-white dark:bg-gray-700 dark:text-gray-400 border-b border-t">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3">Shipping adress </th>
              ...
              <tbody>
                <tr className="bg-white dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100">
                  <th scope="row" className="px-6 py-4 font-medium text-gray-400 whitespace-nowrap dark:text-white">
                    <img src="/img/Esterhoward.svg" alt="T-shirt" />
                  </th>
                  <td className="px-6 py-4">Ester howard</td>
                  <td className="px-6 py-4">Esterhoward@gmai.com</td>
                  
                  <td className="px-6 py-4">Apt. 240 147 Boyce Mountain, Weissnatbury</td>
                  <td className="px-11 py-4">⋯</td>
                </tr>

                <tr className="bg-white dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100">
                  <th scope="row" className="px-6 py-4 font-medium text-gray-400 whitespace-nowrap dark:text-white">
                    <img src="/img/Esterhoward.svg" alt="Pink T-shirt" />
                  </th>
                  <td className="px-6 py-4">Ester howard</td>
                  <td className="px-6 py-4">Esterhoward@gmai.com</td>
                ...
                <tr className="bg-white dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100">
                  <th scope="row" className="px-6 py-4 font-medium text-gray-400 whitespace-nowrap dark:text-white">
                    <img src="/img/Esterhoward.svg" alt="Monochromatic T-shirt" />
                  </th>
                  <td className="px-6 py-4">Ester howard</td>
                  <td className="px-6 py-4">Esterhoward@gmail.com</td>
                ...
                <tr className="bg-white dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100">
                  <th scope="row" className="px-6 py-4 font-medium text-gray-400 whitespace-nowrap dark:text-white">
                    <img src="/img/Esterhoward.svg" alt="Mockup T-shirt" />
                  </th>
                  <td className="px-6 py-4">Ester howard</td>
                  <td className="px-6 py-4">Esterhoward@gmai.com</td>
                ...
                <tr className="bg-white dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100">
                  <th scope="row" className="px-6 py-4 font-medium text-gray-400 whitespace-nowrap dark:text-white">
                    <img src="/img/Esterhoward.svg" alt="Cozy black T-shirt" />
                  </th>
                  <td className="px-6 py-4">Ester howard</td>
                  <td className="px-6 py-4">Esterhoward@gmai.com</td>
                ...
                <tr className="bg-white dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100">
                  <th scope="row" className="px-6 py-4 font-medium text-gray-400 whitespace-nowrap dark:text-white">
                    <img src="/img/Esterhoward.svg" alt="Basic Red T-shirt" />
                  </th>
                  <td className="px-6 py-4">Ester howard</td>
                  <td className="px-6 py-4">Esterhoward@gmai.com</td>
...
export default Costumersadminpage;